...
- O papel `controller` cria, distribui e revisa tarefas; `executor` assume e entrega tarefas.
- O Executor usa apenas a entrada resolvida pelo comando `contexto`; nunca procure nem abra gabaritos.
